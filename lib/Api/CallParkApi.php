...
class CallParkApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1AccountAccountIDParkedcallGet'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->v1AccountAccountIDParkedcallGetWithHttpInfo($account_id, $contentType);
        return $response;
    }

    /**
     * Operation v1AccountAccountIDParkedcallGetWithHttpInfo
     *
     * Get Call Park List
     *
     * @param  string $account_id Account ID, 32 alpha numeric (required)
    ...
    /**
     * Operation v1AccountAccountIDParkedcallGetAsync
     *
     * Get Call Park List
     *
     * @param  string $account_id Account ID, 32 alpha numeric (required)
     ...
     */
    public function v1AccountAccountIDParkedcallGetAsync($account_id, string $contentType = self::contentTypes['v1AccountAccountIDParkedcallGet'][0])
    {
        return $this->v1AccountAccountIDParkedcallGetAsyncWithHttpInfo($account_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1AccountAccountIDParkedcallGetAsyncWithHttpInfo
     *
     * Get Call Park List
     *
     * @param  string $account_id Account ID, 32 alpha numeric (required)
    ...
    /**
     * Create request for operation 'v1AccountAccountIDParkedcallGet'
     *
     * @param  string $account_id Account ID, 32 alpha numeric (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1AccountAccountIDParkedcallGet'] to see the possible values for this operation
     *
     ...
     */
    public function v1AccountAccountIDParkedcallGetRequest($account_id, string $contentType = self::contentTypes['v1AccountAccountIDParkedcallGet'][0])
    {

        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling v1AccountAccountIDParkedcallGet'
            );
        }


        $resourcePath = '/v1/account/{accountID}/parkedcall';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
