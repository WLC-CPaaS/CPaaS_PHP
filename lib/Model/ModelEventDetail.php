...
/**
 * ModelEventDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelEventDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model.EventDetail';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('exec_status', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['exec_status'];
    }

    /**
     * Sets exec_status
     *
     * @param string|null $exec_status exec_status
     *
     * @return self
     */
    public function setExecStatus($exec_status)
    {
        if (is_null($exec_status)) {
            throw new \InvalidArgumentException('non-nullable exec_status cannot be null');
        }
        $this->container['exec_status'] = $exec_status;
