...
/**
 * ServiceDeviceStatusOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceDeviceStatusOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.DeviceStatusOutput';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('registrable', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['registrable'];
    }

    /**
     * Sets registrable
     *
     * @param bool|null $registrable registrable
     *
     * @return self
     */
    public function setRegistrable($registrable)
    {
        if (is_null($registrable)) {
            throw new \InvalidArgumentException('non-nullable registrable cannot be null');
        }
        $this->container['registrable'] = $registrable;
