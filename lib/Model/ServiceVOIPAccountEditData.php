...
/**
 * ServiceVOIPAccountEditData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceVOIPAccountEditData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.VOIPAccountEditData';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ServiceVOIPAccountEditData., must be smaller than or equal to 128.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) > 32)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling ServiceVOIPAccountEditData., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($timezone) < 5)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling ServiceVOIPAccountEditData., must be bigger than or equal to 5.');
        }
