...
/**
 * ServiceMediaOutputShort Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceMediaOutputShort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.MediaOutputShort';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_prompt', $data ?? [], null);
    ...
    */
     ...
     * Sets is_prompt
     *
     * @param bool|null $is_prompt is_prompt
     *
     * @return self
     */
    public function setIsPrompt($is_prompt)
    {
        if (is_null($is_prompt)) {
            throw new \InvalidArgumentException('non-nullable is_prompt cannot be null');
        }
