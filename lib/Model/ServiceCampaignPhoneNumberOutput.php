...
/**
 * ServiceCampaignPhoneNumberOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceCampaignPhoneNumberOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.CampaignPhoneNumberOutput';
    ...
    {
        $this->setIfExists('telephone_numbers', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string[]|null $telephone_numbers telephone_numbers
     *
     * @return self
     */
    public function setTelephoneNumbers($telephone_numbers)
    {
        if (is_null($telephone_numbers)) {
            throw new \InvalidArgumentException('non-nullable telephone_numbers cannot be null');
        }
