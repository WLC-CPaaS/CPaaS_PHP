...
/**
 * ServiceE911LocationURI Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceE911LocationURI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.E911LocationURI';
    ...
    protected static $openAPITypes = [
        ...
        'latitude' => 'float',
        'legacy_data' => '\OpenAPI\Client\Model\ServiceE911LocationURILegacyData',
        'location_id' => 'string',
        'longitude' => 'float',
        'plus_four' => 'string',
        'postal_code' => 'string',
        'state' => 'string',
        'status' => '\OpenAPI\Client\Model\ServiceE911LocationURIStatus',
        'type' => 'string',
        'update_time' => 'string'
    ];
    ...
    */
     ...
     * Gets legacy_data
     *
     * @return \OpenAPI\Client\Model\ServiceE911LocationURILegacyData|null
     */
     ...
     * Sets legacy_data
     *
     * @param \OpenAPI\Client\Model\ServiceE911LocationURILegacyData|null $legacy_data legacy_data
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ServiceE911LocationURIStatus|null $status status
     *
     * @return self
     */
