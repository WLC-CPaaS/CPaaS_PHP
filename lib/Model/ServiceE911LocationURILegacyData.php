...
/**
 * ServiceE911LocationURILegacyData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceE911LocationURILegacyData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service_E911LocationURI_legacyData';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('predirectional', $data ?? [], null);
    ...
    */
     ...
     * Sets predirectional
     *
     * @param string|null $predirectional predirectional
     *
     * @return self
     */
    public function setPredirectional($predirectional)
    {
        if (is_null($predirectional)) {
            throw new \InvalidArgumentException('non-nullable predirectional cannot be null');
        }
