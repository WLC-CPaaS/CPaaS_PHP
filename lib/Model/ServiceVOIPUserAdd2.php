...
/**
 * ServiceVOIPUserAdd2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceVOIPUserAdd2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service.VOIPUserAdd2';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ServiceVOIPUserAdd2., must be smaller than or equal to 254.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ServiceVOIPUserAdd2., must be bigger than or equal to 3.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ServiceVOIPUserAdd2., must be smaller than or equal to 128.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ServiceVOIPUserAdd2., must be smaller than or equal to 128.');
        }
